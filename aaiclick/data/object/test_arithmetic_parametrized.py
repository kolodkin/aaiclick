...
@pytest.mark.parametrize(
    ...
    [
        # Addition tests
        pytest.param(100, 50, "+", 150, id="int-add-basic"),
        pytest.param(0, 0, "+", 0, id="int-add-zeros"),
        pytest.param(-10, 5, "+", -5, id="int-add-negative"),
        pytest.param(1000, 2000, "+", 3000, id="int-add-large"),
        # Subtraction tests
        pytest.param(100, 30, "-", 70, id="int-sub-basic"),
        pytest.param(0, 0, "-", 0, id="int-sub-zeros"),
        pytest.param(50, 100, "-", -50, id="int-sub-negative-result"),
        pytest.param(1000, 1, "-", 999, id="int-sub-large"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # Addition tests
        pytest.param([1, 2, 3], [10, 20, 30], "+", [11, 22, 33], id="int-add-basic"),
        pytest.param([0, 0, 0], [1, 2, 3], "+", [1, 2, 3], id="int-add-zeros"),
        pytest.param([-5, -10, -15], [5, 10, 15], "+", [0, 0, 0], id="int-add-canceling"),
        pytest.param([100, 200], [50, 75], "+", [150, 275], id="int-add-large"),
        # Subtraction tests
        pytest.param([100, 200, 300], [10, 20, 30], "-", [90, 180, 270], id="int-sub-basic"),
        pytest.param([10, 20, 30], [10, 20, 30], "-", [0, 0, 0], id="int-sub-zeros"),
        pytest.param([5, 10, 15], [10, 20, 30], "-", [-5, -10, -15], id="int-sub-negative"),
        pytest.param([1000, 2000], [1, 2], "-", [999, 1998], id="int-sub-large"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # Addition tests
        pytest.param(100.5, 50.25, "+", 150.75, id="float-add-basic"),
        pytest.param(0.0, 0.0, "+", 0.0, id="float-add-zeros"),
        pytest.param(-10.5, 5.25, "+", -5.25, id="float-add-negative"),
        pytest.param(3.14159, 2.71828, "+", 5.85987, id="float-add-pi-e"),
        # Subtraction tests
        pytest.param(100.5, 30.25, "-", 70.25, id="float-sub-basic"),
        pytest.param(0.0, 0.0, "-", 0.0, id="float-sub-zeros"),
        pytest.param(50.5, 100.5, "-", -50.0, id="float-sub-negative-result"),
        pytest.param(10.0, 0.1, "-", 9.9, id="float-sub-small"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # Addition tests
        pytest.param([10.0, 20.0, 30.0], [5.0, 10.0, 15.0], "+", [15.0, 30.0, 45.0], id="float-add-basic"),
        pytest.param([0.0, 0.0], [1.5, 2.5], "+", [1.5, 2.5], id="float-add-zeros"),
        pytest.param([-5.5, -10.5], [5.5, 10.5], "+", [0.0, 0.0], id="float-add-canceling"),
        pytest.param([1.1, 2.2, 3.3], [0.1, 0.2, 0.3], "+", [1.2, 2.4, 3.6], id="float-add-decimals"),
        # Subtraction tests
        pytest.param([100.5, 200.5, 300.5], [10.5, 20.5, 30.5], "-", [90.0, 180.0, 270.0], id="float-sub-basic"),
        pytest.param([10.0, 20.0], [10.0, 20.0], "-", [0.0, 0.0], id="float-sub-zeros"),
        pytest.param([5.5, 10.5], [10.5, 20.5], "-", [-5.0, -10.0], id="float-sub-negative"),
        pytest.param([100.0, 200.0], [0.1, 0.2], "-", [99.9, 199.8], id="float-sub-small"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param([42], [8], "+", [50], id="int-add-single"),
        pytest.param([100], [30], "-", [70], id="int-sub-single"),
        # Large numbers
        pytest.param([1000000], [2000000], "+", [3000000], id="int-add-large"),
        pytest.param([999999999], [1], "+", [1000000000], id="int-add-very-large"),
        # Very small floats
        pytest.param([0.001, 0.002], [0.003, 0.004], "+", [0.004, 0.006], id="float-add-small"),
        # Negative numbers
        pytest.param([-100, -200], [-50, -75], "+", [-150, -275], id="int-add-negative"),
        pytest.param([-10, -20], [-5, -10], "-", [-5, -10], id="int-sub-negative"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # (a + b) - c
        pytest.param([10, 20, 30], [5, 10, 15], [3, 6, 9], "+", "-", [12, 24, 36], id="int-add-sub"),
        # (a - b) + c
        pytest.param([100, 200], [30, 60], [5, 10], "-", "+", [75, 150], id="int-sub-add"),
        # (a + b) + c
        pytest.param([1, 2], [3, 4], [5, 6], "+", "+", [9, 12], id="int-add-add"),
        # (a - b) - c
        pytest.param([100, 200], [10, 20], [5, 10], "-", "-", [85, 170], id="int-sub-sub"),
    ],
)
