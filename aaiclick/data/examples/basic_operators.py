...
async def example():
    ...
    obj_a = await create_object_from_value([10.0, 20.0, 30.0], with_aai_id=True)
    obj_b = await create_object_from_value([2.0, 4.0, 5.0], with_aai_id=True)
    ...
    obj_x = await create_object_from_value([1, 5, 10, 15], with_aai_id=True)
    obj_y = await create_object_from_value([5, 5, 8, 20], with_aai_id=True)
    ...
    obj_m = await create_object_from_value([12, 10, 8], with_aai_id=True)  # Binary: 1100, 1010, 1000
    obj_n = await create_object_from_value([10, 12, 4], with_aai_id=True)  # Binary: 1010, 1100, 0100
