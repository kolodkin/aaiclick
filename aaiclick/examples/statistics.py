...
on Objects containing numeric data.
"""
...
async def main():
    ...
    try:
        ...
        obj_int = await aaiclick.create_object_from_value(int_data)
        ...
        obj_a = await aaiclick.create_object_from_value(data_a)
        obj_b = await aaiclick.create_object_from_value(data_b)
        ...
        obj_temp = await aaiclick.create_object_from_value(temperatures)
        ...
        single_value = [42.0]
        obj_single = await aaiclick.create_object_from_value(single_value)
        ...
        for obj_to_delete in objects_to_delete:
            await obj_to_delete.delete_table()
            print(f"Deleted table {obj_to_delete.table}")
