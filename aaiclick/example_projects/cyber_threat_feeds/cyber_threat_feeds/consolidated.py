...
CONSOLIDATED_COLUMNS = {
    "cve_id": ColumnInfo(type="String"),
    "source": ColumnInfo(type="String"),
    "is_kev": ColumnInfo(type="Bool", nullable=True),
    "vendor": ColumnInfo(type="String", nullable=True),
    "product": ColumnInfo(type="String", nullable=True),
    "vulnerability_name": ColumnInfo(type="String", nullable=True),
    "short_description": ColumnInfo(type="String", nullable=True),
    "date_added": ColumnInfo(type="Date", nullable=True),
    "known_ransomware": ColumnInfo(type="String", nullable=True),
    "cvss": ColumnInfo(type="Float64", nullable=True),
    "cvss_v2": ColumnInfo(type="Float64", nullable=True),
    "cvss_v3": ColumnInfo(type="Float64", nullable=True),
    "epss": ColumnInfo(type="Float64", nullable=True),
    "ranking_epss": ColumnInfo(type="Float64", nullable=True),
    "summary": ColumnInfo(type="String", nullable=True),
}

MERGED_COLUMNS = {
    "cve_id": ColumnInfo(type="String", description="CVE identifier (GROUP BY key)"),
    "sources": ColumnInfo(type="String", array=True, description="Contributing feeds, e.g. ['kev','shodan','epss']"),
    "is_kev": ColumnInfo(
        type="Bool", nullable=True, description="True if CVE is in the CISA KEV catalog (from source data)"
    ),
    "vendor": ColumnInfo(type="String", nullable=True, description="Vendor name (any() aggregated)"),
    "product": ColumnInfo(type="String", nullable=True, description="Product name (any() aggregated)"),
    "vulnerability_name": ColumnInfo(type="String", nullable=True, description="Vulnerability title from KEV"),
    "short_description": ColumnInfo(type="String", nullable=True, description="Brief description from KEV"),
    "date_added": ColumnInfo(type="Date", nullable=True, description="Date added to KEV catalog"),
    "known_ransomware": ColumnInfo(type="String", nullable=True, description="Ransomware campaign linkage"),
    ...
    "summary": ColumnInfo(type="String", nullable=True, description="Vulnerability description from Shodan"),
}
...
async def build_consolidated_table(
    ...
    shodan_view = cves.rename({"kev": "is_kev"}).with_columns({"source": literal("shodan", "String")})
