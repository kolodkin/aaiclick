...
- New test file `aaiclick/orchestration/execution/test_docker_worker.py`
  covering: build cache hits, cache misses, registry push/pull, exit-code
  translation, timeout, cancel, the ghost-container invariant.
