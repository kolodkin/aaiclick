...
**All entities use uint64 Snowflake IDs** generated by the aaiclick framework (not database auto-increment):

- **Job IDs**: Framework-generated uint64 snowflake IDs
- **Task IDs**: Framework-generated uint64 snowflake IDs
- **Group IDs**: Framework-generated uint64 snowflake IDs
...
**Database Storage**:
- PostgreSQL type: `BIGINT` (int64, signed)
- Python/SQLModel type: `int` (unbounded)
- Snowflake IDs fit within BIGINT range (use < 63 bits)
...
# Correct: ID generated by framework, stored as BIGINT in PostgreSQL
