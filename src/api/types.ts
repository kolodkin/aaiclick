...
export type InviteUserRequest = S["InviteUserRequest"];
export type ScopeLevel = S["ApiTokenView"]["scope"];
export type Role = S["UserView"]["role"];
export type SetRoleRequest = S["SetRoleRequest"];
export type InviteView = S["InviteView"];
...
export type AuditEntryView = S["AuditEntryView"];
